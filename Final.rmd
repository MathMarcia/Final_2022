...
Above is the effectiveness for the covid-19 vaccine for male. If the effectiveness is above 50% that means that the vaccine is effective. Based on the interval seen above, we cn conclude that the vaccine is ineffective in protecting males from getting covid-19. 
...
The information to play close attention to among all of these results is the output of the Fisher's test. The p-value displayed above is extremely small at 0.0003. This is a small number. seeing this number means that these results are not likely to occur by chance and so the null hypothesis can be rejected in favor of the alternative.
...
Above is the effectiveness for the covid-19 vaccine for female. If the effectiveness is above 50% that means that the vaccine is effective. Based on the interval seen above, we cn conclude that the vaccine is ineffective in protecting females from getting covid-19. 

The odds ratio is approximately how effective the vaccine is. The odds ratio for the females can be seen above as 60%. The effectiveness confidence interval for the males is 54.53 - 65.07. It is a 95% interval. I notice that female is lower than male.
